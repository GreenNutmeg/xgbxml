...
class WindowType_auto():
	...
	@property
	def windowTypeIsSchematic(self):
		return self.get_attribute('windowTypeIsSchematic')


	@windowTypeIsSchematic.setter
	def windowTypeIsSchematic(self,value):
		self.set_attribute('windowTypeIsSchematic',value)
...
class Zone_auto():
	...
	@property
	def DesignHeatRH(self):
		return self.get_child('DesignHeatRH')


	@property
	def DesignHeatRHs(self):
		return self.get_children('DesignHeatRH')


	def add_DesignHeatRH(self,
		):
		return self.add_child('DesignHeatRH',
			)


	@property
	def DesignCoolRH(self):
		return self.get_child('DesignCoolRH')


	@property
	def DesignCoolRHs(self):
		return self.get_children('DesignCoolRH')


	def add_DesignCoolRH(self,
		):
		return self.add_child('DesignCoolRH',
			)
	...
	@property
	def ZoneHVACEquipmentId(self):
		return self.get_child('ZoneHVACEquipmentId')


	@property
	def ZoneHVACEquipmentIds(self):
		return self.get_children('ZoneHVACEquipmentId')


	def add_ZoneHVACEquipmentId(self,
		zoneHVACEquipmentIdRef=None,
		):
		return self.add_child('ZoneHVACEquipmentId',
			zoneHVACEquipmentIdRef=zoneHVACEquipmentIdRef,
			)
...
class ZoneHVACEquipment_auto():
	"""Represents an early-stage equipment placeholder that provides heating or cooling to part of an air system or a water loop (EnergyPlus and Open Studio)."""

	@property
	def zoneHVACEquipmentType(self):
		return self.get_attribute('zoneHVACEquipmentType')


	@zoneHVACEquipmentType.setter
	def zoneHVACEquipmentType(self,value):
		self.set_attribute('zoneHVACEquipmentType',value)
	...
	@property
	def drawVentilation(self):
		return self.get_attribute('drawVentilation')


	@drawVentilation.setter
	def drawVentilation(self,value):
		self.set_attribute('drawVentilation',value)
	...
	@property
	def AirSystemId(self):
		return self.get_child('AirSystemId')


	@property
	def AirSystemIds(self):
		return self.get_children('AirSystemId')


	def add_AirSystemId(self,
		airSystemIdRef=None,
		):
		return self.add_child('AirSystemId',
			airSystemIdRef=airSystemIdRef,
			)
...
class ZoneHVACEquipmentId_auto():
	""""""

	@property
	def zoneHVACEquipmentIdRef(self):
		"""An unique identifier referencing a zone equipment."""
		return self.get_attribute('zoneHVACEquipmentIdRef')


	@zoneHVACEquipmentIdRef.setter
	def zoneHVACEquipmentIdRef(self,value):
		self.set_attribute('zoneHVACEquipmentIdRef',value)
